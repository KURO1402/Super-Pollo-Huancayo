...
('apertura', '2025-12-01 08:00:00', 1, 8),
('cierre',   '2025-12-01 20:00:00', 1, 8),
('apertura', '2025-12-10 08:15:00', 2, 9),
('cierre',   '2025-12-10 21:00:00', 2, 9),
('apertura', '2025-12-20 09:00:00', 3, 10),
('cierre',   '2025-12-20 22:00:00', 3, 10);
...
('ingreso', '2025-12-01 10:30:00', 300.00, 'Venta del día',       1, 8),
('egreso',  '2025-12-01 15:00:00', 100.00, 'Compra de insumos',   1, 8),
('ingreso', '2025-12-10 12:00:00', 500.00, 'Pago de clientes',    2, 9),
('egreso',  '2025-12-10 18:30:00', 200.00, 'Pago de servicios',   2, 9),
('ingreso', '2025-12-20 14:00:00', 800.00, 'Ventas varias',       3, 10),
('egreso',  '2025-12-20 19:00:00', 300.00, 'Gastos operativos',   3, 10);
...
('2025-12-01 19:50:00',  700.00, 400.00, 100.00, 0.00, 0.00, 'cuadra', 1, 8),
('2025-12-10 20:45:00',  900.00, 500.00, 100.00, 0.00, 0.00, 'cuadra', 2, 9),
('2025-12-20 21:50:00', 1200.00, 500.00, 100.00, 0.00, 0.00, 'cuadra', 3, 10);
...
(1, 1, 0.25), -- 1/4 de pollo usa 0.25 unidades de pollo
(1, 2, 0.40), -- 1/4 de pollo usa 0.40 kg de papa
(2, 1, 1.00), -- Pollo entero usa 1.00 unidad de pollo
(3, 5, 1.00); -- Gaseosa usa 1 unidad de gaseosa insumo
...
(1, 5, '2025-12-15 12:00:00', '2025-12-15 12:05:00', '2025-12-15 12:05:00'),
(3, 6, '2025-12-18 19:30:00', '2025-12-18 19:35:00', '2025-12-18 19:35:00'),
(5, 7, '2025-12-22 13:00:00', '2025-12-22 13:05:00', '2025-12-22 13:05:00');
...
('2025-12-05', '13:00:00', 4, 'completado', 'RES001', '2025-12-04 10:00:00', 1),
('2025-12-10', '20:00:00', 2, 'completado', 'RES002', '2025-12-09 09:30:00', 2),
('2025-12-15', '12:30:00', 6, 'completado', 'RES003', '2025-12-14 11:00:00', 3),
('2025-12-22', '19:00:00', 4, 'cancelado',  'RES004', '2025-12-21 08:45:00', 4),
('2026-01-05', '13:30:00', 3, 'pendiente',  'RES005', '2026-01-04 14:00:00', 1),
('2026-01-10', '20:30:00', 5, 'pendiente',  'RES006', '2026-01-09 16:20:00', 2),
('2026-01-15', '12:00:00', 2, 'pendiente',  'RES007', '2026-01-14 10:10:00', 3);

-- MESAS_RESERVACION
INSERT INTO mesas_reservacion (id_mesa, id_reservacion, reserva_desde, reserva_hasta) VALUES
(2, 1, '2025-12-05 13:00:00', '2025-12-05 15:00:00'),
(4, 2, '2025-12-10 20:00:00', '2025-12-10 22:00:00'),
(1, 3, '2025-12-15 12:30:00', '2025-12-15 14:30:00'),
(3, 3, '2025-12-15 12:30:00', '2025-12-15 14:30:00'),
(6, 4, '2025-12-22 19:00:00', '2025-12-22 21:00:00'),
(7, 5, '2026-01-05 13:30:00', '2026-01-05 15:30:00'),
(8, 6, '2026-01-10 20:30:00', '2026-01-10 22:30:00'),
(5, 7, '2026-01-15 12:00:00', '2026-01-15 14:00:00');

-- PAGO_RESERVACION
INSERT INTO pago_reservacion (monto_pagado, id_transaccion, fecha_pago, estado_pago, id_reservacion) VALUES
(28.00, 'TXN-001-2025', '2025-12-04 10:05:00', 'confirmado', 1),
(14.00, 'TXN-002-2025', '2025-12-09 09:35:00', 'confirmado', 2),
(42.00, 'TXN-003-2025', '2025-12-14 11:10:00', 'confirmado', 3),
(28.00, 'TXN-004-2025', '2025-12-21 08:50:00', 'fallido',    4),
(21.00, 'TXN-005-2026', '2026-01-04 14:05:00', 'confirmado', 5),
(35.00, 'TXN-006-2026', '2026-01-09 16:25:00', 'pendiente',  6),
(14.00, 'TXN-007-2026', '2026-01-14 10:15:00', 'pendiente',  7);
...
('12345678',    1, 18.00,  33.90,  6.10,  40.00, 1, '2025-12-01 12:00:00'),
('87654321',    1, 18.00,  47.46,  8.54,  56.00, 2, '2025-12-01 14:30:00'),
('20512345678', 2, 18.00,  84.75, 15.25, 100.00, 2, '2025-12-10 13:00:00'),
('11223344',    1, 18.00,  20.34,  3.66,  24.00, 1, '2025-12-10 19:00:00'),
('44332211',    1, 18.00,  55.93, 10.07,  66.00, 1, '2025-12-20 12:30:00'),
('55667788',    1, 18.00,  38.14,  6.86,  45.00, 2, '2025-12-20 20:00:00'),
('99887766',    1, 18.00,  30.51,  5.49,  36.00, 1, '2026-01-15 13:00:00'),
('33445566',    1, 18.00,  16.95,  3.05,  20.00, 1, '2026-02-01 11:30:00');

-- COMPROBANTES
INSERT INTO comprobantes (id_venta, id_tipo_comprobante, serie, numero_correlativo, fecha_emision, fecha_vencimiento, sunat_transaccion, aceptado_por_sunat, url_comprobante_pdf, url_comprobante_xml, fecha_envio) VALUES
(1, 1, 'B001', 1, '2025-12-01', '2025-12-31', 1, 1, 'https://storage.sunat.pe/pdf/B001-1.pdf', 'https://storage.sunat.pe/xml/B001-1.xml', '2025-12-01 12:05:00'),
(2, 1, 'B001', 2, '2025-12-01', '2025-12-31', 1, 1, 'https://storage.sunat.pe/pdf/B001-2.pdf', 'https://storage.sunat.pe/xml/B001-2.xml', '2025-12-01 14:35:00'),
(3, 2, 'F001', 1, '2025-12-10', '2026-01-10', 1, 1, 'https://storage.sunat.pe/pdf/F001-1.pdf', 'https://storage.sunat.pe/xml/F001-1.xml', '2025-12-10 13:05:00'),
(4, 1, 'B001', 3, '2025-12-10', '2025-12-31', 1, 1, 'https://storage.sunat.pe/pdf/B001-3.pdf', 'https://storage.sunat.pe/xml/B001-3.xml', '2025-12-10 19:05:00'),
(5, 1, 'B001', 4, '2025-12-20', '2026-01-20', 1, 1, 'https://storage.sunat.pe/pdf/B001-4.pdf', 'https://storage.sunat.pe/xml/B001-4.xml', '2025-12-20 12:35:00'),
(6, 1, 'B001', 5, '2025-12-20', '2026-01-20', 1, 0, 'https://storage.sunat.pe/pdf/B001-5.pdf', 'https://storage.sunat.pe/xml/B001-5.xml', '2025-12-20 20:05:00'),
(7, 1, 'B001', 6, '2026-01-15', '2026-02-15', 1, 1, 'https://storage.sunat.pe/pdf/B001-6.pdf', 'https://storage.sunat.pe/xml/B001-6.xml', '2026-01-15 13:05:00'),
(8, 1, 'B001', 7, '2026-02-01', '2026-03-01', 1, 1, 'https://storage.sunat.pe/pdf/B001-7.pdf', 'https://storage.sunat.pe/xml/B001-7.xml', '2026-02-01 11:35:00');
...
('2026-03-01 12:05:00', 'completado', '2026-03-01 13:10:00', 40.00),
('2026-03-01 14:35:00', 'completado', '2026-03-01 15:50:00', 56.00),
('2026-03-01 13:05:00', 'completado', '2026-03-01 14:20:00', 87.00),
('2026-03-01 19:05:00', 'completado', '2026-03-01 20:35:00', 24.00),
('2026-03-01 12:35:00', 'completado', '2026-03-01 13:45:00', 66.00),
('2026-03-01 20:05:00', 'completado', '2026-03-01 21:30:00', 45.00),
('2026-03-01 13:05:00', 'completado', '2026-03-01 14:15:00', 36.00),
('2026-03-01 11:30:00', 'completado', '2026-03-01 12:55:00', 20.00);
...
(4,  2),
(1,  3),
(3,  3), -- pedido 3 ocupa 2 mesas (grupo grande)
(3,  4),
(5,  5),
(7,  6),
(2,  7),
